  ...
  <form name="form2" method="post" action="delall.jsp">
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">
      <tr>
        ...
        <td bgcolor='#339999'>标题</td>
        <td bgcolor='#339999'>类别</td>
        <td bgcolor='#339999'>添加人</td>
        <td bgcolor='#339999'>首页图片</td>
        <td bgcolor='#339999'>点击率</td>
        <td width="138" align="center" bgcolor="339999">添加时间</td>
        <td width="60" align="center" bgcolor="339999">操作</td>
        <td width="50" align="center" bgcolor="339999"><input name="plxz" type="checkbox" id="plxz" onClick="checkall();" value="1">
