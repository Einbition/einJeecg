...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td width="44" bgcolor='#339999'>用户名</td>
    <td width="30" bgcolor='#339999'>密码</td>
    <td width="30" bgcolor='#339999'>姓名</td>
    <td width="30" bgcolor='#339999'>性别</td>
    <td width="59" bgcolor='#339999'>出生年月</td>
    <td width="22" bgcolor='#339999'>QQ</td>
    <td width="30" bgcolor='#339999'>邮箱</td>
    <td width="38" bgcolor='#339999'>电话</td>
    <td width="78" bgcolor='#339999'>身份证</td>
    <td width="94" bgcolor='#339999'>头像</td>
    <td width="82" bgcolor='#339999'>地址</td>
    <td width="55" bgcolor='#339999'>备注</td>
    <td width="94" align="center" bgcolor="339999">添加时间</td>
    
    <td width="52" align="center" bgcolor="339999">审核</td>
    <td width="71" align="center" bgcolor="339999">操作</td>
  </tr>
   <% 
