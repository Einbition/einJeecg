...
<div class="fxmain">
  ...
  <div class="fxmain_nr">
   ...
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit5" value="切换视图"  style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='leibiexinxilisttp.jsp';" />
</form>
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">  
  ...
  <% 
    ...
    String url = "leibiexinxilist.jsp?2=2"; 
...
if(request.getParameter("leibie")=="" ||request.getParameter("leibie")==null ){}else{sql=sql+" and leibie like '%"+request.getParameter("leibie")+"%'";}
  ...
  <tr>
    ...
    <td><%=map.get("leibie") %></td><td><%=map.get("tedian") %></td>
    
    <td width="30" align="center"> <a href="leibiexinxidetail.jsp?id=<%=map.get("id")%>" >详细</a></td>
  </tr>
  	<%
  }
   %>
