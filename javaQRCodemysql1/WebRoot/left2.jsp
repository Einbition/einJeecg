...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="system_log">
			...
			<dd class="first_dd"><a href="yonghuzhuce_updt2.jsp" target="rightFrame">个人资料管理</a></dd>

		</dl>
	
		<dl class="custom">
			<dt onClick="changeImage()">购买记录管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="goumaijilu_list2.jsp" target="rightFrame">购买记录查询</a></dd>
			<dd><a href="dingdanxinxi_list2.jsp" target="rightFrame">订单信息查询</a></dd>

		</dl>
	
		<dl class="channel">
			<dt onClick="changeImage()">收藏记录管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="shoucangjilu_list2.jsp" target="rightFrame">收藏记录查询</a></dd>
